...
final statusTypeNotifierProvider = StateNotifierProvider<StatusType, String>((ref){
  return StatusType();
});

class StatusAchievement extends StateNotifier<Uncomplete>{
  StatusAchievement() : super(Uncomplete(achievementRate: 0, uncompleteCount: 0));
...
final statusQnaNotifierProvider = 
StateNotifierProvider<StatusQna, Qna>((ref){
  return StatusQna();
});
