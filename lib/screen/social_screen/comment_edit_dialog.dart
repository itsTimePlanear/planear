...
Future<bool> showCommentEditDialog(BuildContext context, WidgetRef ref) async {
  bool result = false;
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        ...
                        "취소",
                        style:
                            FontStyles.Btn.copyWith(color: Color(0xFFDC0000)),
                      )),
                    ),
                  ),
                  Gap(15),
                  GestureDetector(
                    onTap: () async {
                      ...
                      final selectedQuestionId =
                          ref.read(selectedProviderState);
                      if (currentPage == 0) {
                        ...
                        if (selectedQuestionId != null) {
                          if (editingText != "") {
                            ref
                                ...
                                .addCoin(5);
                            await postQuestions(
                                ref, "QNA", editingText, selectedQuestionId);
