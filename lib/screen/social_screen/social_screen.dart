...
class SocialScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _SocialScreenState();
}
...
class _SocialScreenState extends ConsumerState<SocialScreen> {
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext ctx, int idx) {
          ...
          return _avatarCardWidget(
              item.nickname, achievementRate, item.items!, schedule);
        }
      },
  ...
  Widget _avatarCardWidget(
      String name, int percent, List<ItemsAcievement> items, int schedule) {
    Widget isSchedule;
    if (schedule == 0) {
      isSchedule = Text(
        "일정 없음",
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              name,
              style: FontStyles.socialName.copyWith(color: Colors.black),
            ),
            Gap(5),
            isSchedule, Gap(2),
          ],
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              name,
              style: FontStyles.socialName.copyWith(color: Colors.white),
            ),
            Gap(5),
            isSchedule,
            Gap(2),
      ...
      children: [
        Container(
          child: Stack(children: [
            Container(
              padding: const EdgeInsets.only(right: 60, top: 8,bottom: 8 ,left: 10),
              width: MediaQuery.sizeOf(context).width - 50,
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(10), color: Colors.white),
              child: Text(
                "상태 메세지를 업데이트 해 친구들에게 공유하세요.",
                style: FontStyles.Week.copyWith(color: Colors.black),
              ),
            ),
            GestureDetector(
              child: SvgPicture.asset("assets/icons/social_pencil.svg"),
              onTap: () async {
                ref.read(stateMessageChangeProvider.notifier).setTrue();
  ...
  Widget _messageContainer(
    ...
    return Column(
      children: [
        ...
        if (type == "TODAY_SCHEDULE") ...[_stateMessageTwo(schedule)],
        if (type == "QNA") ...[_stateMessageThree(question, answer)]
      ],
    );
  }
            ...
            children: [
              ...
              Stack(alignment: Alignment.centerRight, children: [
                ...
                Positioned(
                  ...
                  radius: 55,
                  lineWidth: 20,
                  percent: total.toDouble() / 100,
                  center: new Text(
                    "${total}%",
                    style:
                        TextStyle(fontSize: 24, fontFamily: 'PretendardSemi'),
                  ),
        ...
        children: [
          Column(
            ...
            children: [
              Text("오늘의 일정",
                  style:
                      FontStyles.CommentCard.copyWith(color: AppColors.main1)),
            ],
          ),
          Gap(80),
          Flexible(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Gap(6),
          Text(
            "Q. ${question}" ?? '질문을 선택하세요',
            style: FontStyles.CommentCard,
          ),
          Gap(15),
          Row(
